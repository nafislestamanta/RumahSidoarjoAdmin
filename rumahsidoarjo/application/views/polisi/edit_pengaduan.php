   ...
   <div class="container-fluid">
       ...
       <section class="content">
           <div class="card card-primary">
               <form action="<?php echo base_url('Polisi/updatepengaduan/' . $edit->id_laporan); ?> " method="POST"
                   ...
                   <div class="table-responsive">
                       ...
                       <a class="btn btn-warning" href="<?= base_url('Polisi/laporan'); ?>" role="button">kembali</a>
                   </div>
               </form>
           </div>
       </section>
