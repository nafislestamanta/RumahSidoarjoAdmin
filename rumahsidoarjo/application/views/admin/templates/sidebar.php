 ...
 <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <a class="sidebar-brand d-flex align-items-center justify-content-center">
         <div class="sidebar-brand-icon"> <br>
             ...
             <img class="img-profile rounded-circle" style="padding-top: px;" src="<?= base_url('assets'); ?>/img/sidoarjo.PNG" widht="60" height="60">
             <br>
     ...
     <?php $role = $this->session->userdata('id_role');
        ...
        if ($role == 1) : ?>
         ...
         <li class="nav-item">
             <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse18" aria-expanded="true" aria-controls="collapse18">
