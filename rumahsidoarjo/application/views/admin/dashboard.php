<!-- <?php
        $kategori = mysqli_query($connect, "SELECT kategori FROM panik_button GROUP BY kategori");
        $jumlah = mysqli_query($connect, "SELECT SUM(row)")
        ?> -->
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-7">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-center">TEST</h6>
                </div>
                <div class="card-body">
                    <div class="chart-bar">
