  ...
  <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">Tambah Data Komunitas</h1>
              ...
              <dic class="card-body">
                      ...
                      <div class="col-sm-12">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="" name=""
                                  placeholder="Masukkan nama komunitas" value="<?= set_value('') ?>">
                  ...
                  <div class="row">
                      <div class="col-sm-12">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="" name="" placeholder="Masukkan no. telepon"
                                  value="<?= set_value('') ?>">
                              <?= form_error('', '<small class="text-danger pl-2">', '</small>');  ?>
                          </div>
                      </div>
                  ...
                  <div class="row">
                      <div class="form-group">
                          ...
                          <a href="<?= base_url('Komunitas') ?>" class="btn btn-success"> Kembali</a>
