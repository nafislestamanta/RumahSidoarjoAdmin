                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    <?php if ($detail->foto1) : ?>
                                        <td>
                                            ...
                                            <div class="form-group">
                                                <br>
                                                <img src="<?= base_url('assets/img/' . $detail->foto1); ?>" width="150px">
                                            </div>
                                        </td>
                                    <?php else : ?>
                                        <td>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group">
                                            <br>
                                            <img src="<?= base_url('assets/img/' . $detail->foto2); ?>" width="150px">
                                        </div>
                                    </td>
                                    <td>
                                        <?= $this->session->flashdata('alert'); ?>
                                        <div class="form-group">
                                            <br>
                                            <img src="<?= base_url('assets/img/' . $detail->foto3); ?>" width="150px">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
