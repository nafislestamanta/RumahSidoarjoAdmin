                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <br>
                                                <img src="<?= base_url('assets/img/' . $ulasan->foto1); ?>" width="90px" alt="Belum Upload">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <br>
                                                <img src="<?= base_url('assets/img/' . $ulasan->foto2); ?>" width="90px" alt="Belum Upload">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <br>
                                                <img src="<?= base_url('assets/img/' . $ulasan->foto3); ?>" width="90px" alt="Belum Upload">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
