  ...
  <div class="container-fluid">
    ...
    <div class="col">
      <div class="card card-primary">
        <div class="card-body">
          <form action="<?php echo base_url('Pendidikan/simpanSMP') ?> " method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-12">
                <!-- text input -->
                <div class="form-group">
                  <label class=" font-weight-bold text-dark">Nama SMP</label>
                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama SMP" value="<?= set_value('nama') ?>">
