  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Tambah Data SD</h1>
    ...
    <div class="col">
      <div class="card card-primary">
        <div class="card-body">
          <form action="<?php echo base_url('Pendidikan/simpanSD') ?> " method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-12">
                <!-- text input -->
                <div class="form-group">
                  <label class=" font-weight-bold text-dark">Nama SD</label>
                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama SD" value="<?= set_value('nama') ?>">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="notelp" name="notelp" placeholder="Masukkan No Telepon" value="<?= set_value('notelp') ?>">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="npsn" name="npsn" placeholder="Masukkan NPSN" value="<?= set_value('npsn') ?>">
