      ...
      <section class="content">
          <div class="col">
              <div class="card card-primary">
                  <form action="<?php echo base_url('LowonganKerja/save') ?> " method="POST"
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input name="nama_perusahaan" id="nama_perusahaan" type="text"
                                          ...
                                          oninvalid="this.setCustomValidity('Nama Perusahaan tidak boleh kosong!')"
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input name="no_tlp" id="no_tlp" type="number" class="form-control"
                                          placeholder="No Telepon Perusahaan" required
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input name="penanggung_jawab" id="penanggung_jawab" type="text"
                                          class="form-control" placeholder="Penanggung Jawab Perusahaan" required
